...
var t = {
    ...
    watch: {
        ...
        options: {
            deep: !0, handler(t, e) { JSON.stringify(t) !== JSON.stringify(e) && this.$el.mathfield.setOptions(t) }
        }
    },
    mounted() {
        this.$nextTick((() => {
            this.$mathlive.makeMathField(this.$el, {
                ...this.options,
                onContentDidChange: t => { this.$emit("input", this.$el.mathfield.getValue()) },
                onFocus: t => { this.$emit("focus") },
                onBlur: t => { this.$emit("blur") },
                onUndoStateDidChange: (t, e) => { this.$emit("undo-state-did-change", e) },
                onReadAloudStatus: (t, e) => { this.$emit("read-aloud-status-change", e) },
    ...
    methods: {
        ...
        }, select() { this.$el.mathfield.select() }
    }
}; export default t;
